...
# ---------- 基因集（symbol 级别）----------
gs <- list(
  PTLD_obstructive_IFN = c("IFI6","OAS1","OAS2",                       # Kenyan 论文 STRING 核心
  ...
  HALLMARK_IFNa = c("ISG15","MX1","OAS1","OAS2","IFIT1","IFIT2","IFIT3",
  ...
  HALLMARK_IFNg = c("STAT1","STAT2","IRF1","IRF2","IRF7","IRF8","IRF9",
